...
export default function Page() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col bg-[#F3E9D9]">
      ...
      {/* Form */}
        <section className="flex-1 w-full flex items-center justify-center px-6 -mt-55">
            <form onSubmit={onSubmit} className="w-full max-w-2xl space-y-9">
                {/* Full name */}
                <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-6 mb-10">
                <label
                    htmlFor="fullName"
